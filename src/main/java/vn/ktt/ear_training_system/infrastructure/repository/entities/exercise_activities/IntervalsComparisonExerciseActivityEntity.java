...
@Setter
@NoArgsConstructor
public class IntervalsComparisonExerciseActivityEntity extends ExerciseActivityEntity {
    private IntervalTexture texture;
    private MusicalInterval firstInterval;
    private MusicalInterval secondInterval;

    public IntervalsComparisonExerciseActivityEntity(IntervalTexture texture, MusicalInterval firstInterval, MusicalInterval secondInterval, int position) {
        super(position);
